...
@endsection
@section('title_toolbar', 'Nouveau Client Paiement')
@section('subtitle_toolbar', 'Gestion des Client Paiements')
@section('content')
    <div class="card">
        <div class="card-body">
            <form  method="POST" action="{{ route('customerpayements.store', $customerinvoice->id) }}" id="customerpayementform">
                @csrf
            <div class="modal-header">
                <h5 class="modal-title">Create Paiement Client</h5>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$customerinvoice->num_customer_invoices}}">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="form-group">
                                <label>Montant A Payer</label>
                                <input type="text" name="amount_to_be_paid" class="amount_to_be_paid" value="{{$customerinvoice->total_customer_invoices}}" readonly>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group mb-0">
                                <label>Note</label>
                                <textarea class="form-control" name="description_customer_payment"></textarea>
                            </div>
                        </div>
                    </div>
