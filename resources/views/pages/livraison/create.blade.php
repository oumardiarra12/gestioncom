                            ...
                            <div class="tab_content" data-tab="{{ $category->id }}">
                                <div class="row">
                                    @foreach ($category->products as $product)
                                        <div class="col-lg-3 col-sm-6 d-flex addcard">
                                            <div
                                                class="{{ $product->category_id ? 'productset flex-fill active' : 'productset flex-fill' }}">
                                                <div class="productsetimg">
                                                    <img src="{{ asset('/storage/imageproduits/' . $product->image_product) }}"
                                                        alt="img">
                                                    <h6>Stock: {{ $product->stock_actuel }}</h6>
                        ...
                        <form method="POST">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table table-borderless" id="tablecard">
                                    ...
                                    <td><div class="increment-decrement">
                                        <div class="input-groups">
                                            <input type="number" name="child" value="0">
                                        </div>
                                    </div></td>
                                    <td>2000</td>
                                    <td><a class="confirm-text" href="javascript:void(0);"><img
    ...
    <script>
        $(document).ready(function() {
            ...
            function updatePrice() {
                $('#tablecard tr').each(function(i, element) {
                    var html = $(this).html();
                    if (html != '') {
                        var qty = $(this).find('.qty_linecomptoir').val();
                        var price = $(this).find('.price_linecomptoir').val();
                        $(this).find('.subtotal_linecomptoir').val(qty * price);
                        totalVente();
                    }
                });
            }
            ...
            $(".addcard").on("click", function() {
                // var row = $("#hdnRows").val();
                $("#tablecard").append(`<tr>
                    <td><div class="d-flex p-0">
                                        <div>
                                            <img src="assets/img/product/product30.jpg" alt="img">
                                        </div>
                                        <div>
                                            <input type="text" class="border border-white" id="products_id" name="products_id[]" value="Product1" readonly="readonly"/>
                                            <input type="hidden" name="products_id[]" class="products_id"  />
                                            <input type="hidden" name="price_linecomptoir[]" value="150" class="price_linecomptoir" />
                                        </div>
                                    </div>
                                    </td>
                                    <td><div class="input-group"><input name="qty_linecomptoir[]" value="1" class="form-control qty_linecomptoir" required=""/></div></td>
                                    <td class="w-25"><input  name="subtotal_linecomptoir[]" class="form-control border border-white subtotal_linecomptoir"></td>
