                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td class="productimgname">
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <select class="js-example-basic-single select2 form-control ProductName products_id" id="elementrecep" name="products_id[]" data-placeholder="Choisir un produit"  @error("products_id") is-invalid @enderror>
                            ...
                            <div class="col-lg-12 float-md-right">
                                <div class="total-order">
                                    <ul>
                                        <li class="total">
                                            <h4>Total</h4>
                                            <input type="number" class="form-control total_reception" name="total_reception" @error("total_reception") is-invalid @enderror readonly>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-10 col-sm-10 col-10">
                                                            <div class="col-md-10">
                                                                <select class="js-example-basic-single select2 form-control ProductName products_id" name="products_id[]" id="elementrecep" data-placeholder="Choisir un produit"  @error("products_id") is-invalid @enderror>
                                                                    <option selected="true" disabled="true">Choisir Produit</option>
                                                                @foreach ($products as $product)
                                                                    <option value="{{ $product->id }}" data-price_line_purchase_order="{{$product->price_purchase}}">
                                                                        {{ $product->name_product }}</option>
