    ...
    <div id="invoiceholder">
        ...
        <div id="invoice" class="effect2">
            ...
            <div id="invoice-top">
                ...
                <!--End Info-->
                <div class="title">
                    <h3>Bon Retour chez le Fournisseur</h3>
                    <h5>No #{{ $returnPurchase->num_return_purchase }}</h5>
                    <h5>{{ $returnPurchase->created_at->format('d-m-Y') }}
            ...
            <div id="invoice-mid">
                ...
                <div class="info">
                    <h2>{{ $returnPurchase->supplier->name_supplier }}</h2>
                    <p>{{ $returnPurchase->supplier->email_contact_supplier }}</br>
                        {{ $returnPurchase->supplier->tel_supplier }}</br>
                </div>
            ...
            <div id="invoice-bot">
                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext">{{$lignereturnPurchase->product->name_product}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lignereturnPurchase->qty_line_return_purchase}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lignereturnPurchase->price_return_purchase}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lignereturnPurchase->subtotal_return_purchase}}</p>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr class="tabletitle">
                            ...
                            <td class="payment">
                                <h2>{{$returnPurchase->total_return_purchase}}</h2>
                            </td>
                        </tr>
