...
@section('title_toolbar', 'Detail Facture Vente')
    ...
    <div class="card">
        <div class="card-body">
            <div class="card-sales-split">
                <h2>Detail Facture Vente : {{ $customerinvoice->num_purchase_invoice }}</h2>
                <ul>
                    <li>
                        <a href="{{ route('ventefactures.ventefacturepdf', $customerinvoice->id) }}"><img
                                        ...
                                        <tr>
                                            <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        ...
                                                        {{ $customerinvoice->deliveries->customer_order->customer->firstname_customer ?? '' }}
                                                    </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $customerinvoice->deliveries->customer_order->customer->lastname_customer ?? '' }}
                                                    </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        ...
                                                        <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                                            data-cfemail="3a4d5b565117535417594f494e55575f487a5f425b574a565f14595557">[{{ $customerinvoice->deliveries->customer_order->customer->email_customer ?? '' }}&#160;protected]</a>
                                                    </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $customerinvoice->deliveries->customer_order->customer->tel_customer ?? '' }}
                                                    </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $customerinvoice->deliveries->customer_order->customer->address_customer ?? '' }}
                                                    </font>
                                                </font><br>
                                            </td>
                                            <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                            ...
                                            <td style="padding:5px;vertical-align:top;text-align:right;padding-bottom:20px">
                                                ...
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">
                                                        {{ $customerinvoice->num_customer_invoices ?? '' }} </font>
                                                </font><br>
                                                <font style="vertical-align: inherit;">
                                                    <font
                                                        style="vertical-align: inherit;font-size: 14px;color:#2E7D32;font-weight: 400;">
                                                        {{ $customerinvoice->status_customer_invoices ?? '' }}</font>
                                                </font><br>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        @foreach ($lignecustomerinvoices as $lignecustomerinvoice)
                            <tr class="details" style="border-bottom:1px solid #E9ECEF ;">
                                <td style="padding: 10px;vertical-align: top; display: flex;align-items: center;">
                                    {{ $lignecustomerinvoice->product->name_product }}
                                </td>
                                <td style="padding: 10px;vertical-align: top; ">
                                    {{ $lignecustomerinvoice->qty_line_customer_invoice }}
                                </td>
                                <td style="padding: 10px;vertical-align: top; ">
                                    {{ $lignecustomerinvoice->price_line_customer_invoice }}
                                </td>
                                <td style="padding: 10px;vertical-align: top; ">
                                    {{  $lignecustomerinvoice->subtotal_line_customer_invoice }}
                                </td>
                            </tr>
                        @endforeach
                ...
                <div class="col-lg-12 ">
                    <div class="total-order w-100 max-widthauto m-auto mb-4">
                        <ul>
                            <li class="total">
                                <h4>Total</h4>
                                <h5>{{$customerinvoice->total_customer_invoices}}</h5>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12 ">
                    <div class="total-order w-100 max-widthauto m-auto mb-4">
                        <ul>
                            <li class="total">
                                <h4>Description</h4>
                                <div>{{ $customerinvoice->description_customer_invoices }}</div>
                            </li>
                        </ul>
                    </div>
                </div>
