...
@section('title_toolbar', 'La liste des Facture Ventes')
        ...
        <div class="card-body">
            <div class="table-top">
                ...
                <div class="wordset">
                    <ul>
                        <li>
                            <a href="{{ route('ventefactures.pdftable') }}"><img src="assets/img/icons/pdf.svg"
                                    alt="img"></a>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                <input type="text" name="num_customer_invoices" placeholder="Entre le Numero de Facture"
                                    id="num_customer_invoices" onkeyup="searchNumFacture()">
                            </div>
                        </div>
                        <div class="col-lg-1 col-sm-6 col-12">
                            <div class="form-group">
                                <select class="select" id="status_customer_invoices" onchange="searchStatusfacture()">
                    ...
                    <tbody>
                        @foreach ($customerinvoices as $customerinvoice)
                            <tr>
                                {{-- <td>
                                    <label class="checkboxs">
                                        <input type="checkbox" value="{{ $customerinvoice->id }}">
                                        <span class="checkmarks"></span>
                                    </label>
                                </td> --}}
                                <td>{{ $customerinvoice->num_customer_invoices }}</td>
                                <td @if($customerinvoice->status_customer_invoices =='no pay')  style="color: red;" @elseif ($customerinvoice->status_customer_invoices=="partial pay") style="color: yellow;" @else style="color: green;" @endif>{{ $customerinvoice->status_customer_invoices }}</td>
                                ...
                                <td class="text-center">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{ route('ventefactures.show', $customerinvoice->id) }}"
                                                class="dropdown-item"><img src="assets/img/icons/eye1.svg" class="me-2"
                                                    alt="img" />Détail</a>
                                        </li>
                                        @if($customerinvoice->status_customer_invoices =='no pay')
                                        <li>
                                            <a href="{{ route('ventefactures.edit', $customerinvoice->id) }}"
                                        ...
                                        <li>
                                            <form class="delete-item d-inline" method="post"
                                                action="{{ route('ventefactures.delete', $customerinvoice->id) }}">
                                                @csrf
                                                @method('delete')
                                        ...
                                        @endif
                                        @if($customerinvoice->status_customer_invoices =='no pay' || $customerinvoice->status_customer_invoices =='partial pay' )
                                        <li>
                                            <a href="{{route('customerpayements.create',$customerinvoice->id)}}" class="dropdown-item"><img src="assets/img/icons/plus-circle.svg" class="me-2" alt="img">Create Paiment</a>
                                            </li>
                                        @endif
                                        @if($customerinvoice->status_customer_invoices =='pay' || $customerinvoice->status_customer_invoices =='partial pay' )
                                            <li>
                                                <a href="{{route('customerpayements.showpayment',$customerinvoice->id)}}" class="dropdown-item" ><img src="assets/img/icons/dollar-square.svg" class="me-2" alt="img">Show Paiments</a>
                                                </li>
                                        @endif
...
@section('script')
    <script>
        function searchNumFacture() {
            ...
            input = document.getElementById("num_customer_invoices");
        ...
        function searchStatusfacture() {
            var input, filter, table, tr, td, i, txtValue;
            input = document.getElementById("status_customer_invoices");
            filter = input.value.toUpperCase();
            table = document.getElementById("factureTable");
            tr = table.getElementsByTagName("tr");
            for (i = 0; i < tr.length; i++) {
