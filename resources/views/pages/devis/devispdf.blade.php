    ...
    <div id="invoiceholder">
        ...
        <div id="invoice" class="effect2">
            ...
            <div id="invoice-top">
                ...
                <div class="title">
                    <h3>Bon Devis</h3>
                    <h5>No #{{ $estimate->num_estimates }}</h5>
                    <h5>{{ $estimate->created_at->format('d-m-Y') }}
            ...
            <div id="invoice-mid">
                ...
                <div class="info">
                    <h2>{{ $estimate->customer->firstname_customer }}</h2>
                    <h2>{{ $estimate->customer->lastname_customer }}</h2>
                    <p>{{ $estimate->customer->email_customer }}</br>
                        {{ $estimate->customer->tel_customer }}</br>
                        {{ $estimate->customer->address_customer }}</br>
                </div>
            ...
            <div id="invoice-bot">
                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext">{{$ligneestimate->product->name_product}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$ligneestimate->qty_line_estimate}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$ligneestimate->price_line_estimate}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$ligneestimate->subtotal_line_estimate}}</p>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr class="tabletitle">
                            ...
                            <td class="payment">
                                <h2>{{$estimate->total_estimates}}</h2>
                            </td>
                        </tr>
