    ...
    <div id="invoiceholder">
        ...
        <div id="invoice" class="effect2">
            ...
            <div id="invoice-top">
                ...
                <!--End Info-->
                <div class="title">
                    <h3>Bon Commande Achat</h3>
                    <h5>No #{{ $purchaseorder->num_purchase_order }}</h5>
                    <p>{{ $purchaseorder->created_at->format('d-m-Y') }}</br>
            ...
            <div id="invoice-mid">
                ...
                <div class="info">
                    <h2>{{ $purchaseorder->supplier->name_supplier }}</h2>
                    <p>{{ $purchaseorder->supplier->email_contact_supplier }}</br>
                        {{ $purchaseorder->supplier->tel_supplier }}</br>
                </div>
            ...
            <div id="invoice-bot">
                ...
                <div id="table">
                    <table>
                        ...
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext">{{$lingepurchase->product->name_product}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lingepurchase->qty_line_purchase_order}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lingepurchase->price_line_purchase_order}}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{$lingepurchase->subtotal_line_purchase_order}}</p>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        <tr class="tabletitle">
                            ...
                            <td class="payment">
                                <h2>{{$purchaseorder->total_purchase_order}}</h2>
                            </td>
                        </tr>
